meta =
{
    ...
    name = "Trash Manager Revamped",

    -- Title of your mod that will be displayed to players
    title = "Trash Manager Revamped",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Revamped with new features and mod stability to work in the current Avorion version. This mod is integrated into Cosmic Overhaul!",
    ...
    dependencies = {
        ...
        { id = "3315794988", exact = "*.*", incompatible = true },
    ...
    contact = "Drop any comments regarding this mod reupload and I'll look into it.",
}
